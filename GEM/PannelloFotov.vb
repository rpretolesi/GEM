...
Public Class PannelloFotov
    ...
    Protected Overrides Sub ToolStripButton_Nuovo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not m_bs.DataSource Is Nothing Then
            ...
            Me.TextBox_PF_Marca.Text = ""
            Me.TextBox_PF_Modello.Text = ""
        ...
        If Not m_bs.DataSource Is Nothing Then
            ...
            If Not m_bs.Current() Is Nothing Then
                ...
                Try
                    ...
                    strSQL = strSQL + "WHERE PF_ID = @PF_ID AND PF_CC = @PF_CC "
                    ...
                    cmd.Parameters.AddWithValue("@PF_ID", dr.Item("PF_ID"))
                    cmd.Parameters.AddWithValue("@PF_CC", dr.Item("PF_CC"))
                ...
                If m_bs.DataSource.Rows.Count > 0 Then
                    For Each dr As DataRow In m_bs.DataSource.Rows
                        If dr.RowState = DataRowState.Modified Then
                            ...
                            strSQL = " UPDATE [PannelloFotov] "
                            strSQL = strSQL + " SET PF_Marca = @PF_Marca, PF_Modello = @PF_Modello, PF_DataOra = @PF_DataOra, PF_U_ID = @PF_U_ID "
                            strSQL = strSQL + " WHERE PF_ID = @PF_ID AND PF_CC = @PF_CC "
                            ...
                            dr.Item("PF_Marca") = Me.TextBox_PF_Marca.Text
                            dr.Item("PF_Modello") = Me.TextBox_PF_Modello.Text
                            dr.Item("PF_DataOra") = Date.Now
                            dr.Item("PF_U_ID") = m_iUID
                            dr.Item("U_NomeCognome") = GetUNomeCognome(m_iUID)

                            cmd.Parameters.Clear()
                            cmd.Parameters.AddWithValue("@PF_ID", dr.Item("PF_ID"))
                            cmd.Parameters.AddWithValue("@PF_CC", dr.Item("PF_CC"))
                            cmd.Parameters.AddWithValue("@PF_Marca", dr.Item("PF_Marca"))
                            cmd.Parameters.AddWithValue("@PF_Modello", dr.Item("PF_Modello"))
                            cmd.Parameters.AddWithValue("@PF_DataOra", dr.Item("PF_DataOra"))
                            cmd.Parameters.AddWithValue("@PF_U_ID", m_iUID)
                        ...
                        ElseIf dr.RowState = DataRowState.Added Then
                            ...
                            strSQL = " INSERT INTO [PannelloFotov] "
                            strSQL = strSQL + "  (PF_Marca,  PF_Modello,  PF_DataOra,  PF_U_ID) VALUES "
                            strSQL = strSQL + "  (@PF_Marca, @PF_Modello, @PF_DataOra, @PF_U_ID) "
                            strSQL = strSQL + " SELECT @PF_ID = SCOPE_IDENTITY() "
                            ...
                            cmd.Parameters.Clear()
                            cmd.Parameters.Add("@PF_ID", SqlDbType.Int).Direction = ParameterDirection.Output
                            cmd.Parameters.AddWithValue("@PF_Marca", dr.Item("PF_Marca"))
                            cmd.Parameters.AddWithValue("@PF_Modello", dr.Item("PF_Modello"))
                            cmd.Parameters.AddWithValue("@PF_DataOra", dr.Item("PF_DataOra"))
                            cmd.Parameters.AddWithValue("@PF_U_ID", dr.Item("PF_U_ID"))

                            If cmd.ExecuteNonQuery() > 0 Then
                                dr.Item("PF_ID") = cmd.Parameters.Item("@PF_ID").Value
    ...
    Protected Overrides Sub BaseForm_1_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs)
        ...
        If (Me.TextBox_PF_Marca.DataBindings.Count > 0) Then
            Me.TextBox_PF_Marca.DataBindings.Clear()
        End If
        If (Me.TextBox_PF_Modello.DataBindings.Count > 0) Then
            Me.TextBox_PF_Modello.DataBindings.Clear()
        End If
    ...
    Private Sub CaricaDati()
        ...
        Try
            ...
            strSQL = " SELECT PF_ID, PF_Marca, PF_Modello, PF_DataOra, PF_U_ID, Utente.U_NomeCognome, PF_CC "
            strSQL = strSQL + " FROM PannelloFotov INNER JOIN Utente ON PF_U_ID = U_ID "
    ...
    Private Sub EseguiBinding()
        If Not m_bs.DataSource Is Nothing Then
            ...
            Me.Label_PF_Marca.Text = m_bs.DataSource.Columns("PF_Marca").Caption
            Me.Label_PF_Modello.Text = m_bs.DataSource.Columns("PF_Modello").Caption

            If (Me.TextBox_PF_Marca.DataBindings.Count = 0) Then
                Me.TextBox_PF_Marca.DataBindings.Add(New Binding("Text", m_bs, "PF_Marca", True))
            End If
            If (Me.TextBox_PF_Modello.DataBindings.Count = 0) Then
                Me.TextBox_PF_Modello.DataBindings.Add(New Binding("Text", m_bs, "PF_Modello", True))
            End If

        End If

        Me.TextBox_PF_Marca.ReadOnly = True
        Me.TextBox_PF_Modello.ReadOnly = True
    End Sub
    ...
    Private Sub RimuoviBinding()
        ...
        Me.TextBox_PF_Marca.ReadOnly = False
        Me.TextBox_PF_Modello.ReadOnly = False
    End Sub
